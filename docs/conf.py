...
# -*- coding: utf-8 -*-
#
# cookiecutter-go documentation build configuration file, created by
...
htmlhelp_basename = 'cookiecutter-godoc'
...
latex_documents = [
  (master_doc, 'cookiecutter-go.tex', 'cookiecutter-go Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'cookiecutter-go', 'cookiecutter-go Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'cookiecutter-go', 'cookiecutter-go Documentation',
   author, 'cookiecutter-go', 'One line description of project.',
   'Miscellaneous'),
]
